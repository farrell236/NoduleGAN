        ...
        for i in range(start_res_log2, target_res_log2 + 1):
            ...
            to_rgb = Sequential(
                [
                    ...
                    EqualizedConv(N_CHANNELS, 1, gain=1),   # CHANGE NO OF CHANNELS
                ],
...
class Discriminator:
    def __init__(self, start_res_log2, target_res_log2):
        ...
        for res_log2 in range(self.start_res_log2, self.target_res_log2 + 1):
            ...
            from_rgb = Sequential(
                [
                    layers.InputLayer(
                        input_shape=(res, res, N_CHANNELS), name=f"from_rgb_input_{res}"  # CHANGE NO OF CHANNELS
                    ),
    ...
    def grow(self, res_log2):
        ...
        input_image = layers.Input(shape=(res, res, N_CHANNELS), name="input_image")  # CHANGE NO OF CHANNELS
